...
class MembreAdapter(private val students: List<Utilisateur>) :
    RecyclerView.Adapter<MembreAdapter.MembreViewHolder>() {
        ...
        fun bind(utilisateur : Utilisateur) {
            ...
            favoriteImageView.setOnClickListener {
                val dialog = DialogBotYesNo(
                    ...
                    message = "Voullez-vous ajouter ce membre à votre favoris?",
                    positiveButtonAction = {},
                    negativeButtonAction = {}
                    )
                dialog.showDialog()
