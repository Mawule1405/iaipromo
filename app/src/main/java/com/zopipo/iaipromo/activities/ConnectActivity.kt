...
import com.zopipo.iaipromo.databinding.ActivityConnectBinding
...
class ConnectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(binding.appBarConnect.toolbar)

        binding.appBarConnect.fab.setOnClickListener { view ->
